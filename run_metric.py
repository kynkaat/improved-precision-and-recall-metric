...
import dnnlib
from dataset_tool import load_dataset
...
realism_config = dnnlib.EasyDict(minibatch_size=8, num_images=50000, num_gen_images=1000, show_n_images=25,
...
def parse_command_line_arguments(args=None):
    ...
    parser.add_argument(
        ...
        '--realism_score',
        action='store_true',
        help='Calculate realism score for StyleGAN samples.'
    )
    parser.add_argument(
        '-t',
        '--truncation_sweep',
        action='store_true',
        help='Calculate StyleGAN truncation sweep.'
    )
